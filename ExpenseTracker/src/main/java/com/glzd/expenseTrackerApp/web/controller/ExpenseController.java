...
public class ExpenseController {
    ...
    @GetMapping("/expenses")
    public String showExpenses(){return "/expenses";}

    @GetMapping("/statistics-data")
    @ResponseBody
    public Map<String, Double> getStatisticsData() {
        List<Expense> monthlyExpenses = expenseService.getExpensesForCurrentMonth();
        return expenseService.calculateExpenseByType(monthlyExpenses);
    }

    @GetMapping("/weekly-expense-data")
    @ResponseBody
    public Map<Integer, Double> getWeeklyExpenseData() {
        List<Expense> expenses = expenseService.getExpensesForCurrentMonth();
        return expenseService.calculateExpenseByWeeklyDates(expenses);
    }
